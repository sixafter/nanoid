...
func (r *poolReader) Read(b []byte) (int, error) {
	prngInstance := prngPool.Get().(io.Reader)
	defer prngPool.Put(prngInstance)
	return prngInstance.Read(b)
}
...
func (e *errorPRNG) Read(b []byte) (int, error) {
	return 0, e.err
}
