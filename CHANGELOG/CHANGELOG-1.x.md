...
### Changed
- **debt:** Upgraded [prng-chacha](http://github.com/sixafter/prng-chacha) to the latest stable version.
- **debt:** Upgraded [aes-ctr-drbg](http://github.com/sixafter/aes-ctr-drbg) to the latest stable version.
- **debt:** Upgraded dependencies to their latest stable versions.
...
### Added
### Changed
- **debt:** Upgraded to `golang.org/x/sys v0.40`
- **debt:** Upgraded to `golang.org/x/crypto v0.47.0`.
...
[Unreleased]: https://github.com/sixafter/nanoid/compare/v1.64.3...HEAD
